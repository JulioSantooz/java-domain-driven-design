...
import aula8.br.com.julio.exception.FalhaValidacaoException;
import aula8.br.com.julio.model.*;
import aula8.br.com.julio.pillarsPOO.enums.TipoCapaEnum;
...
public class CadastroLivros {
    public static void main(String[] args) {
        ...
        try {
            LogUtils.info("===========> INÍCIO DA EXECUÇÃO DO REGISTRO DE LIVROS <===========");
...
//        carrinho.adicionar(livroDeBolsoFavorito);
            ...
            LogUtils.info("Total: R$ "+carrinho.total());
        } catch (FalhaValidacaoException e) {
            LogUtils.error("Verifique os dados: "+e.getMessage());
        } catch (RuntimeException e) {
            LogUtils.error("Verifique os dados: "+e.getMessage());
        } catch(Exception e) {
            LogUtils.error("Erro inesperado: "+e.getMessage());
        } finally {
            LogUtils.info("===========> FIM DA EXECUÇÃO DO REGISTRO DE LIVROS <===========");
        }
